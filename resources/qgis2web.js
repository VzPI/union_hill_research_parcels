...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-8832105.450030, 4466435.006339, -8652253.680088, 4563542.472402], maxZoom: 22, minZoom: 4
    })
});
...
map.getView().fit([-8832105.450030, 4466435.006339, -8652253.680088, 4563542.472402], map.getSize());
